...
public:
	...
	virtual void OnUIRender() override
	{
		...
		for (size_t i = 0; i < m_Scene.Materials.size(); i++) {
			ImGui::PushID(i);
			ImGui::LabelText("Material ", "%i", i + 1);
			ImGui::ColorEdit3("Albedo", glm::value_ptr(m_Scene.Materials[i].Albedo));
			ImGui::DragFloat("Roughness", &m_Scene.Materials[i].Roughness, 0.1f, 0.0f, 1.0f);
			ImGui::DragFloat("Metallic", &m_Scene.Materials[i].Metallic, 0.1f, 0.0f, 1.0f);
